...
import 'package:flutter_project_setup_cli/src/command_runner.dart';
...
void main() {
  group('FlutterProjectSetupCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlutterProjectSetupCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlutterProjectSetupCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlutterProjectSetupCliCommandRunner();
